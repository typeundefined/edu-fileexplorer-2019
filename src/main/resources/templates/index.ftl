    ...
    <#switch file_elem.type>
        <#case "DIRECTORY">
            <div class="row bg-white p-3 noselect view"
                 onclick="location.href='/directories/?path=${file_elem.relativePath?url}&sort=DEFAULT'">
                <div class="col media">
...
<div class="container">
    ...
    <div class="row bg-white p-3 border-bottom">
        ...
        <img src="/img/back.png" height="30px" width="30px"
             onclick="location.href='/directories/?path=${backURL?url}&sort=DEFAULT'"/>
        <div class="col">
            <strong>Name</strong>
            <img src="/img/sort-down.png" width="20px" height="20px"
                 onclick="location.href='/directories/?path=${RequestParameters.path?url}&sort=NAME'"/>
        </div>
        <div class="col-6 row">
            <div class="col-8"><strong>Date of change</strong> <img src="/img/sort-down.png" width="20px" height="20px"
                                                                    onclick="location.href='/directories/?path=${RequestParameters.path?url}&sort=DATE'"/>
            </div>
            <div class="col-4"><strong>Size</strong><img src="/img/sort-down.png" width="20px" height="20px"
                                                         onclick="location.href='/directories/?path=${RequestParameters.path?url}&sort=SIZE'"/>
            </div>
        </div>
