...
<#macro page_body>
    ...
    <nav aria-label="breadcrumb">
        ...
        <form action="/logout" method="post">
            ...
            <button name="submit" type="submit" class="btn btn-primary" value="submit" style="float:right">Logout
            </button>
        </form>
            ...
            <form name="uploadingForm" enctype="multipart/form-data" method="POST">
                ...
                <p>
                    <label class="btn btn-outline-secondary">
                        Browse<input id="fileInput" hidden class="btn btn-primary" type="file" name="uploadingFiles"
                                     onchange="updateSize();" multiple>
                    </label>
                    <span class="badge badge-secondary">selected files: <span id="fileNum"
                                                                              class="badge badge-success">0</span></span>
                    <span class="badge badge-secondary">total size: <span id="fileSize"
                                                                          class="badge badge-success">0</span></span>
                    <label class="btn btn-outline-secondary">
    ...
    <form action="/createdir" method="post">
        <div class="input-group-prepend">
            <span class="input-group-text" id="inputGroup-sizing-sm"
                  onclick="parentNode.submit()">Create directory</span>
            <input type="text" name="directory" class="form-control" aria-label="Small"
