...
public class FileExplorerService {
    ...
    private List<FileData> getSortedlist(List<FileData> fileList, SortMethod sortMethod){
        switch (sortMethod){
            case DATE: fileList.sort( Comparator.comparing( FileData::getLastModifiedTime ) );
                break;
            case NAME:fileList.sort( Comparator.comparing( FileData::getName ) );
                break;
            case SIZE:fileList.sort( Comparator.comparing( FileData::getSize ) );
                break;
            default:break;
